    ...
    <section class="container d-flex justify-content-md-center flex-column">
        ...
        <div class="">        
            <ul class="list-group">          
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start  bg-dark bg-opacity-50 " style="min-width: 50rem;">                
                    <div class="">
                        ...
                        <div class=" input-group col-auto">
                            <div class="m-1">
                                <form id="editar{{ $serie['id'] }}" action="{{ route('series.edit', $serie['id']) }}" method="get">                            
                                    <button type="submit" class="btn btn-primary btn-sm btn-opacity-50">Editar</button>  
                                </form>
                            </div>
                            <div class="m-1">
